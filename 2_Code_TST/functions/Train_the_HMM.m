                ...
                while ~finished_sliding_window
                    ...
                    while is_all_empty_in_window
                        for frame = frames_in_window
                            ...
                            %distance_factor_for_accepting_frame + distance_average_of_averages
...
%                             frame
%                             frames_in_window
% %                             if frame == 141 && length(frames_in_window) == 1
% %                                 distance_estimated_class_this_frame
% %                                 distance_factor_for_accepting_frame + distance_average_of_averages
%                                 
%                                 last_accepted_frame_in_previous_window
%                                 do_count_this_frame
%                                 is_all_empty_in_window
%                                 finished_sliding_window
% %                                 which_action
% %                                 which_performance
% %                                 input('ggg: ');
% %                             end
...
M=[7;2;8;6;6;6;7;5];   % the length of M is number_of_actions
