...
global confusion_matrix_Fall_vs_NonFall;
...
for which_action = 1:number_of_actions
    for which_performance = 1:length(HMM_labels_test{which_action})    % test each action for all samples (performances) of test person
        ...
        %%% confusion matrix of fall-versus-nonFall:
        if which_action == 1 || which_action == 2 || which_action == 3 || which_action == 4
            row_confusion_Fall_vs_NonFall = 1;
        else
            row_confusion_Fall_vs_NonFall = 2;
        end
        if estimated_action == 1 || estimated_action == 2 || estimated_action == 3 || estimated_action == 4
            column_confusion_Fall_vs_NonFall = 1;
        else
            column_confusion_Fall_vs_NonFall = 2;
        end
        confusion_matrix_Fall_vs_NonFall(row_confusion_Fall_vs_NonFall, column_confusion_Fall_vs_NonFall, test_person) = confusion_matrix_Fall_vs_NonFall(row_confusion_Fall_vs_NonFall, column_confusion_Fall_vs_NonFall, test_person) + 1;
    end
end
