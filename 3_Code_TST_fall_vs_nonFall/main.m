...
global confusion_matrix_Fall_vs_NonFall; confusion_matrix_Fall_vs_NonFall = zeros(2,2,number_of_persons);
...
%% confusion matrix of "fall versus non-fall actions":
confusion_FallNonFall_mean = mean(confusion_matrix_Fall_vs_NonFall,3);
for row = 1:size(confusion_FallNonFall_mean,1)
    confusion_FallNonFall_mean_percent(row,:) = (confusion_FallNonFall_mean(row,:) ./ sum(confusion_FallNonFall_mean(row,:))) * 100;
end
average_rate_FallNonFall = mean([confusion_FallNonFall_mean_percent(1,1), confusion_FallNonFall_mean_percent(2,2)]);
cd('saved_files')
save confusion_matrix_Fall_vs_NonFall.mat confusion_matrix_Fall_vs_NonFall
save confusion_FallNonFall_mean.mat confusion_FallNonFall_mean
save confusion_FallNonFall_mean_percent.mat confusion_FallNonFall_mean_percent
save average_rate_FallNonFall.mat average_rate_FallNonFall
cd('..')
disp('Fall versus Non-Fall Recognition rate:');
disp(average_rate_FallNonFall);
