function estimated_action_MOTION = Test_Motion_Histograms(test_person, mean_histogram_1D, which_action, which_performance, estimated_action_MOTION, classes_passed_to_motion_section)
...
counter = 1;
for i = classes_passed_to_motion_section
...
estimated_class = classes_passed_to_motion_section(index_min_distance);
