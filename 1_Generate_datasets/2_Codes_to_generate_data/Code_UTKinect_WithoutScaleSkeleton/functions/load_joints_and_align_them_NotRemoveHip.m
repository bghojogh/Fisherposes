function joints = load_joints_and_align_them_NotRemoveHip(which_person,which_performance,which_action,frame)
    global skeleton
    global hip_index;
    ...
    %%%% remove the hip from skeleton:
    %joints(hip_index_after_joint_selection,:) = [];
end