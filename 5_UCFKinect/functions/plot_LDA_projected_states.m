function plot_LDA_projected_states(LDA_projected_joints_of_specific_states, number_of_states, name_of_states, LDA_projected_state_means)
    ...
    MarkersSymbols_plot = {'v', 's', 'd', '^', 'p', 'h', 'o', '>', 's', '<', 'o', 'd'};
    MarkersColors_plot = {[1,1,0], [1,0,1], [0,1,1], [1,0,0], [1,0.5,0], [0,0,1], [0.6,0.4,0.7], [0,1,0], [0.7,0.7,0.7], [0.6,0.5,0.3], [1,0,0.5], [0,0.7,0.3]};
    %%%% 2D plot:
    figure;
