...
for which_action = 1:number_of_actions
    for which_performance = 1:length(HMM_labels_test{which_action})    % test each action for all samples (performances) of test person
        ...
        likelihood = zeros(number_of_actions_in_top_layer,1);
        ...
        if report_estimates_in_HMM_and_motion == 1
            for j = 1:number_of_actions_in_top_layer
                ...
                if j ~= number_of_actions_in_top_layer
                    confidenceMatrix_action_HMM{j}(test_person, which_action, which_performance) = value_sort(j) - value_sort(j+1);
                end
            end
        end
...
%         end
        %%%% create the second-layer (Motion) in UCFKinect:
        ...
        %%%% top actions (here is estimated_action_HMM): 
        ...
        if estimated_action_HMM(test_person, which_action, which_performance) == 1
            estimated_action_TOTAL(test_person, which_action, which_performance) = 1;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 2
            estimated_action_TOTAL(test_person, which_action, which_performance) = 2;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 3  %%--> a basket of actions
            classes_passed_to_motion_section = [3, 7];
            estimated_action_MOTION = Test_Motion_Histograms(test_person, mean_histogram_1D, which_action, which_performance, estimated_action_MOTION, classes_passed_to_motion_section);
        ...
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 4
            estimated_action_TOTAL(test_person, which_action, which_performance) = 4;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 5
            estimated_action_TOTAL(test_person, which_action, which_performance) = 6;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 6
            estimated_action_TOTAL(test_person, which_action, which_performance) = 8;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 7
            estimated_action_TOTAL(test_person, which_action, which_performance) = 9;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 8  %%--> a basket of actions
            classes_passed_to_motion_section = [5, 10, 11, 12, 13];
            estimated_action_MOTION = Test_Motion_Histograms(test_person, mean_histogram_1D, which_action, which_performance, estimated_action_MOTION, classes_passed_to_motion_section);
            estimated_action_TOTAL(test_person, which_action, which_performance) = estimated_action_MOTION(test_person, which_action, which_performance);
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 9
            estimated_action_TOTAL(test_person, which_action, which_performance) = 14;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 10
            estimated_action_TOTAL(test_person, which_action, which_performance) = 15;
        elseif estimated_action_HMM(test_person, which_action, which_performance) == 11
            estimated_action_TOTAL(test_person, which_action, which_performance) = 16;
        end
        %%%% total estimation:
